<template>
  ...
  >
    ...
    <div class="text-lg z-10">
      ...
      making it a piece of cake to keep tabs on what's happening across various
      departments. Effortlessly sharing updates with the team is a breeze too.
      And guess what? When we're all on the same wavelength, success naturally
      follows. So, let's journey towards progress together – it's a smooth
      ride!"
    </div>
  </div>
</template>
