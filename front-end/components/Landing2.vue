  ...
  >
    ...
    >
      ...
      <div class="text-xl leading-9 lg:px-36">
        ...
        various departments. Effortlessly sharing updates with the team is a
        breeze too. And guess what? When we're all on the same wavelength,
        success naturally follows. So, let's journey towards progress together –
        it's a smooth ride!"
      </div>
    </div>
  </div>
